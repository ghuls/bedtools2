...
void groupby_help(void) {
    ...
    cerr                        << "\t\t\tIf there is only one column, but multiple operations, all operations will" << endl;
    cerr                        << "\t\t\tbe applied on that column. Likewise, if there is only one operation, but" << endl;
    cerr                        << "\t\t\tmultiple columns, that operation will be applied to all columns." << endl;
    cerr                        << "\t\t\tOtherwise, the number of columns must match the number of operations," << endl;
    ...
    cerr                        << "\t\t\tThe order of output columns will match the ordering given in the command." << endl << endl;
    ...
    cerr << "\t-prec\t\t"       << "Sets the decimal precision for output." << endl;
